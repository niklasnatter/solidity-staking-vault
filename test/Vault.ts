...
describe("Vault", function () {
  async function deployVaultAndDevUSDC() {
  ...
  describe("Reward Token", function () {
    ...
    it("Should allow setting reward token for owner only", async function () {
  ...
  describe("Deposit", function () {
    ...
    it("Should return correct balances after deposit", async function () {
    ...
    it("Should return correct balances after two successive deposits", async function () {
      const { vault, account1 } = await loadFixture(deployVaultAndDevUSDC);
    ...
    it("Should reject deposit below minimum staking amount", async function () {
      const { vault, account1 } = await loadFixture(deployVaultAndDevUSDC);
  ...
  describe("Withdraw", function () {
    ...
    it("Should return correct balances after partial withdraw", async function () {
      const { vault, account1 } = await loadFixture(deployVaultAndDevUSDC);
    ...
    it("Should return correct balances after full withdraw", async function () {
      const { vault, account1 } = await loadFixture(deployVaultAndDevUSDC);
    ...
    it("Should send ether and rewards to account", async function () {
    ...
    it("Should reject withdrawal that that exceeds account balance", async function () {
      const { vault, account1 } = await loadFixture(deployVaultAndDevUSDC);
    ...
    it("Should reject withdrawal that puts account below minimum staking amount", async function () {
      const { vault, account1 } = await loadFixture(deployVaultAndDevUSDC);
  ...
  describe("Deposit and Withdraw", function () {
    ...
    it("Should return correct balances for simultaneously active users", async function () {
